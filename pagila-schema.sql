...
-- REGLA 1: Un item del inventario no puede estar rentado en intervalos solapados.
...
BEGIN
    ...
    SELECT COUNT(*)
     ...
     WHERE ri.inventory_id = NEW.inventory_id
       AND ri.rental_id <> NEW.rental_id
...
-- REGLA 2: Copias de la misma pelicula y tienda deben tener el mismo precio.
...
-- REGLA 3: payment_date debe ser igual a rental_date.
...
-- REGLA 4: payment.amount debe ser la suma de los items de la renta.
